 ...
 * @description:
 */
public class Follower implements AutoCloseable {

	protected Client client;

	public Follower(final String host, final int port, final String password) {
		this.client = new Client(host, port, password);
	}

	public Follower(final String host, final int port) {

 ...
 * @description:
 */
public class JTile38Leader extends JTile38Follower implements AutoCloseable {


	public JTile38Leader(final String host, final int port, final String password) {
		super(host, port, password);
	}

	public JTile38Leader(final String host, final int port) {
		super(host, port);
	}
